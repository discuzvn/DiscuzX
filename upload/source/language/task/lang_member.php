...
$lang = array(
    ...
    'member_desc' =>
        'Đăng bài, úp ảnh, tạo album, sử dụng đạo cụ, cụ thể là sử dụng các chức năng của diễn đàn.',
    ...
    'member_complete_var_num_comment' =>
        'Thành viên cần phải thực hiện số lượng tối thiểu của hành động tương ứng',
    'member_complete_var_time' => 'Giới hạn thời gian (giờ)',
    'member_complete_var_time_comment' =>
        'Đặt thời gian giới hạn để thành viên phải làm xong nhiệm vụ, đặt 0 hoặc để trống là ko giới hạn.',
