...
$lang = array(
    ...
    'forumlist_fids_comment' =>
        'Điền vào các diễn đàn chỉ định ID (id), nhiều hơn một diễn đàn với một dấu phẩy (,) để ngăn cách nhiều ID.',
    'forumlist_fups' => 'Diễn đàn lớn',
    'forumlist_fups_comment' => 'Hiển thị một số chuyên mục hoặc diễn đàn con',
    'forumlist_titlelength' => 'Độ dài tiêu đề',
    'forumlist_titlelength_comment' => 'Thiết lập độ dài tối đa tiêu đề.',
    'forumlist_summarylength' => 'Độ dài tóm tắt',
    'forumlist_summarylength_comment' => 'Thiết lập độ dài tối đa mô tả',
