...
$lang = array(
    ...
    'jack_info' =>
        '<p class="mtn xw0 mbn">Chủ đề còn có thể ở trên TOP <span class="xi1 xw1 xs2"> {expiration} </span>giờ</p> <p class="mtn xw0 mbn">Bây giờ bạn có<span class="xi1 xw1 xs2"> {magicnum} </span>Đinh sử dụng</p>',
    ...
    'jack_notification' =>
        'Chủ đề {subject} của bạn được {actor} sử dụng {magicname}, <a href="forum.php?mod=viewthread&tid={tid}">Xem</a>',
);
