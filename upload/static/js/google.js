...
document.writeln('<option value="0"' + google_default_0 + '>Tìm kiếm trên web</option>');
document.writeln('<option value="1"' + google_default_1 + '>Tìm kiếm</option>');
document.writeln('</select>');
document.writeln('&nbsp;<button type="submit" name="sa" value="true">Tìm kiếm</button>');
