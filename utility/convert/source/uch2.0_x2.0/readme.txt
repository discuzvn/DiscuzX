===================================
Instructions for upgrading UCenter Home 2.0 to Discuz! X2.0
===================================
...
4. Execute the installation program /install
   When installing, please specify the UCenter Server address where the original UCHome is attached (if the UCenter version is lower than 1.6.0, you need to upgrade UCenter first)
