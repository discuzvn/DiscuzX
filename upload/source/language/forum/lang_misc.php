...
',
    'post_edit_regexp' =>
        '/^\\[i=s\\] Bài được .*? sửa lúc .*?  \\[\\/i\\]\\n\\n/s',
    'post_edithtml' =>
        '[i=s] Bài được {editor} sửa lúc {edittime} [/i]<br /><br />',
    'post_edithtml_regexp' =>
        '/^\\[i=s\\] Bài được .*? sửa lúc .*?  \\[\\/i\\]&lt;br \\/&gt;&lt;br \\/&gt;/s',
    'post_editnobbcode' => '[ Bài được {editor} sửa lúc {edittime} ]\\n\\n',
    'post_editnobbcode_regexp' =>
        '/^\\[ Bài đượcc  .*?  sửa lúc .*?  \\]\\n\\n/s',
    'post_reply' => 'Trả lời',
    'post_thread' => 'Bài mới',
    'price' => 'Giá',
    ...
    'trade_waitsellerconfirm' =>
        'Giao dịch đã thành công, chờ người bán xác nhận',
    'trade_sysconfirmpay' => 'Người mua đang xác nhận, tạm thời chưa gửi hàng',
    'trade_waitsellersend' =>
        'Người mua đã chuyển tiền, đợi người bán gửi hàng',
    'trade_waitbuyerconfirm' =>
        'Người bán đã chuyển hàng, người mua đang xác nhận',
    'trade_syspayseller' =>
        'Người mua đã nhận được hàng, chờ người bán nhận tiền',
    'trade_finished' =>
        '<font color="green">Giao dịch kết thúc thành công</font>',
    'trade_closed' =>
        '<font color="gray">Giao dịch đóng(chưa hoàn thành)</font>',
    'trade_waitselleragree' => 'Chờ cho người bán hoàn toàn đồng ý',
    'trade_sellerrefusebuyer' =>
        'Người bán từ chối yêu cầu người mua, đang chờ người mua thay đổi yêu cầu',
    'trade_waitbuyerreturn' =>
        'Bên bán đồng ý hoàn lại tiền, chờ đợi cho người mua trả lại',
    ...
    'trade_offline_10' =>
        'Tôi muốn trả hàng lại, chờ đợi người bán đồng ý hoàn trả',
    ...
    'trade_message_4' =>
        'Nhập phương thức thanh toán, số tài khoản ngân hàng và các thông tin khác',
    'trade_message_5' =>
        'Nhập công ty vận chuyển, hóa đơn, và các thông tin khác',
    'trade_message_13' =>
        'Nhập công ty vận chuyển, hóa đơn, và các thông tin khác',
    ...
    'formulaperm_and' => 'và',
    'formulaperm_or' => 'hoặc',
    'formulaperm_extcredits' => 'Cài đặt điểm',
    ...
    'uch_noalbum' => 'Bạn chưa có album nào,',
    ...
    'pm_date' => 'Thời gian',
    'share_message' =>
        'Bạn thân mến! tớ thấy ở {$_G[setting][bbname]} có bài viết này, rất có giá trị nên gửi cho bạn xem. \\n\\n$thread[subject]\\n địa chỉ [url={$threadurl}]{$threadurl}[/url]\\n\\n hy vọng bạn sẽ thích.',
    'week_0' => 'Chủ nhật',
    'week_1' => 'Thứ 2',
    'week_2' => 'Thứ 3',
    'week_3' => 'Thứ 4',
    ...
    'perms_allowat' => 'Cho phép tag @người',
    ...
    'crime_postreason' =>
        '{reason} &nbsp; <a href="forum.php?mod=redirect&goto=findpost&pid={pid}&ptid={tid}" target="_blank" class="xi2">Chi tiết </a>',
    'crime_reason' => '{reason}',
    'connectguest_message_search' => array('đăng nhập', 'đăng nhập'),
    'connectguest_message_replace' => array('đăng nhập', 'đăng nhập'),
    'connectguest_message_mobile_search' => array('đăng nhập', 'đăng nhập'),
    'connectguest_message_mobile_replace' =>
        'Hoàn thành thông tin tài khoảng trên Mobile',
    'avatar' => 'Avatar',
    'signature' => 'Chữ ký',
    ...
    'patch_fix_failed_status' => 'Sửa thất bại',
    'patch_fix_right_now' => 'Sửa thành công',
    'patch_view_fix_detail' => 'Chi tiết',
    'patch_name' => 'Tên',
    'patch_dateline' => 'Ngày đăng tậm trạng',
    'patch_status' => 'Hiện tâm trạng',
    'patch_close' => 'Đóng',
    'plugin_title' => 'Nhắc cập nhật',
    'plugin_memo' =>
        'Bạn có <span class="xi1">{number}</span> cập nhật ứng dụng',
