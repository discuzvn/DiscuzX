...
$lang = array(
    ...
    'groupattachment_fids_comment' =>
        'Thiết lập hiện thị ở nhiều diễn đàn.Bạn hãy nhấm giữ phím CTRL để chọn các diễn đàn',
    'groupattachment_tids' => 'Chủ đề',
    'groupattachment_tids_comment' =>
        'Thiết lập id chủ đề cụ thể mà bạn muốn hiển thị, sử dụng "," tách tids',
    'groupattachment_gtids' => 'Danh mục nhóm',
    'groupattachment_gtids_comment' =>
        'Thiết lập danh mục của nhóm, nhấm giữ phím CTRL để chọn các nhóm',
    'groupattachment_startrow' => 'Hàng đầu tiên',
    'groupattachment_startrow_comment' =>
        'Nếu bạn cần phải thiết lập hàng đầu, vui lòng nhập một số, 0 là hàng đầu tiên.',
    'groupattachment_items' => 'Các hàng còn lại.',
    'groupattachment_items_comment' =>
        'Thiết lập số lượng hàng mà bạn muốn hiển thị, nó phải số nguyên lớn hơn 0.',
    'groupattachment_titlelength' => 'Tiêu đề nhóm',
    'groupattachment_titlelength_comment' =>
        'Thiết lập độ dài tối đa của tiêu đề.',
    'groupattachment_summarylength' => 'Mô tả nhóm',
    'groupattachment_summarylength_comment' =>
        'Thiết lập độ dài tối đa của mô tả.',
    'groupattachment_maxwidth' => 'Chiều rộng tối đa hình ảnh, px',
    'groupattachment_maxwidth_comment' =>
        'Thiết lập kích thước hình ảnh tối đa để thu nhỏ chiều rộng này tự động, thiết lập 0 để vô hiệu hóa zoom ảnh',
    'groupattachment_maxheight' => 'Chiều cao tối đa hình ảnh, px',
    'groupattachment_maxheight_comment' =>
        'Thiết lập hình ảnh tự động phóng to đến độ cao này, đặt 0 để vô hiệu hoá tính năng zoom ảnh',
    'groupattachment_threadmethod' => 'Xâu file đính kèm',
    'groupattachment_threadmethod_comment' =>
        'Chọn "Yes" thì file đính kèm sẽ hiện dưới chủ đề, một chủ đề sẽ hiển thị một tập tin đính kèm; "no" Thì mỗi chủ đề sẽ hiện nhiều đính kèm',
    'groupattachment_digest' => 'Lọc phân loại',
    'groupattachment_digest_comment' =>
        'Chọn chủ đề: để có tính năng lọc chủ đề. Lưu ý: Tất cả hoặc không cho vô hiệu hoá tính năng lọc',
    ...
    'groupattachment_special_comment' =>
        'Chọn chủ đề cần lọc đặc biệt. Lưu ý: Tất cả hoặc không cho vô hiệu hoá tính năng lọc',
    ...
    'groupattachment_special_reward' => 'Chọn lọc phần thưởng',
    'groupattachment_special_reward_comment' => 'Chọn loại khen thưởng',
