...
drag.extend({
	'getBlocksTimer' : '',
	'blocks' : [],
	'blockDefaultClass' : [{'key':'Chọn style','value':''},{'key':'Có viền và không viền','value':'cl_block_bm'},{'key':'Style 1','value':'xbs_1'},{'key':'Style 2','value':'xbs xbs_2'},{'key':'Style 3','value':'xbs xbs_3'},{'key':'Style 4','value':'xbs xbs_4'},{'key':'Style 5','value':'xbs xbs_5'},{'key':'Style 6','value':'xbs xbs_6'},{'key':'Style 7','value':'xbs xbs_7'}],
	'frameDefaultClass' : [{'key':'Chọn style','value':''},{'key':'Có viền và không viền','value':'cl_frame_bm'},{'key':'Khung không viền','value':'xfs xfs_nbd'},{'key':'Style 1','value':'xfs xfs_1'},{'key':'Style 2','value':'xfs xfs_2'},{'key':'Style 3','value':'xfs xfs_3'},{'key':'Style 4','value':'xfs xfs_4'},{'key':'Style 5','value':'xfs xfs_5'}],
	...
	openStyleEdit : function (e) {
		...
		var stylearr = [{'key':'Style','value':'none'},{'key':'Solid','value':'solid'},{'key':'Dotted','value':'dotted'},{'key':'Dashed','value':'dashed'}];
		...
		if (objType == 1) {
			...
			table += '<tr><th>Padding</th><td><div id="cmargindiv" class="'+ulclass+'"><span><label>上</label> <input class="px p_fre" id="cmargint" value="'+cmargint+'" size="1" />px </span>';
