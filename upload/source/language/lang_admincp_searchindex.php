...
$lang = array(
    0 => array(
        'index' => array('管理中心首页' => 'action=index'),
        'text' => array(0 => '管理中心首页'),
    ),
    1 => array(
        'index' => array('常用操作管理' => 'action=misc&operation=custommenu'),
        'text' => array(0 => '常用操作管理'),
    ),
    2 => array(
        'index' => array('站点信息' => 'action=setting&operation=basic'),
        'text' => array(0 => '站点信息'),
    ),
    3 => array(
        'index' => array('注册与访问控制' => 'action=setting&operation=access'),
        'text' => array(0 => '注册与访问控制'),
    ),
    4 => array(
        'index' => array('站点功能' => 'action=setting&operation=functions'),
        'text' => array(0 => '站点功能'),
    ),
    5 => array(
        'index' => array('性能优化' => 'action=setting&operation=cachethread'),
        'text' => array(0 => '性能优化'),
    ),
    6 => array(
        'index' => array('SEO设置' => 'action=setting&operation=seo'),
        'text' => array(0 => 'SEO设置'),
    ),
    7 => array(
        'index' => array('域名设置' => 'action=domain'),
        'text' => array(0 => '域名设置'),
    ),
    8 => array(
        'index' => array('广播设置' => 'action=setting&operation=follow'),
        'text' => array(0 => '广播设置'),
    ),
    9 => array(
        'index' => array('空间设置' => 'action=setting&operation=home'),
        'text' => array(0 => '空间设置'),
    ),
    10 => array(
        'index' => array('用户权限' => 'action=setting&operation=permissions'),
        'text' => array(0 => '用户权限'),
    ),
    11 => array(
        'index' => array('积分设置' => 'action=setting&operation=credits'),
        'text' => array(0 => '积分设置'),
    ),
    12 => array(
        'index' => array('时间设置' => 'action=setting&operation=datetime'),
        'text' => array(0 => '时间设置'),
    ),
    13 => array(
        'index' => array('上传设置' => 'action=setting&operation=attach'),
        'text' => array(0 => '上传设置'),
    ),
    14 => array(
        'index' => array('水印设置' => 'action=setting&operation=imgwater'),
        'text' => array(0 => '水印设置'),
    ),
    15 => array(
        'index' => array('附件类型尺寸' => 'action=misc&operation=attachtype'),
        'text' => array(0 => '附件类型尺寸'),
    ),
    16 => array(
        'index' => array('搜索设置' => 'action=setting&operation=search'),
        'text' => array(0 => '搜索设置'),
    ),
    17 => array(
        'index' => array('地区设置' => 'action=district'),
        'text' => array(0 => '地区设置'),
    ),
    18 => array(
        'index' => array('排行榜设置' => 'action=setting&operation=ranklist'),
        'text' => array(0 => '排行榜设置'),
    ),
    19 => array(
        'index' => array('手机版访问设置' => 'action=setting&operation=mobile'),
        'text' => array(0 => '手机版访问设置'),
    ),
    20 => array(
        'index' => array('防采集设置' => 'action=setting&operation=antitheft'),
        'text' => array(0 => '防采集设置'),
    ),
    21 => array(
        'index' => array('导航设置' => 'action=nav'),
        'text' => array(0 => '导航设置'),
    ),
    22 => array(
        'index' => array('界面设置' => 'action=setting&operation=styles'),
        'text' => array(0 => '界面设置'),
    ),
    23 => array(
        'index' => array('风格管理' => 'action=styles'),
        'text' => array(0 => '风格管理'),
    ),
    24 => array(
        'index' => array('模板管理' => 'action=templates'),
        'text' => array(0 => '模板管理'),
    ),
    25 => array(
        'index' => array('表情管理' => 'action=smilies'),
        'text' => array(0 => '表情管理'),
    ),
    26 => array(
        'index' => array('表态动作' => 'action=click'),
        'text' => array(0 => '表态动作'),
    ),
    27 => array(
        'index' => array('主题鉴定' => 'action=misc&operation=stamp'),
        'text' => array(0 => '主题鉴定'),
    ),
    28 => array(
        'index' => array('编辑器设置' => 'action=setting&operation=editor'),
        'text' => array(0 => '编辑器设置'),
    ),
    29 => array(
        'index' => array('在线列表图标' => 'action=misc&operation=onlinelist'),
        'text' => array(0 => '在线列表图标'),
    ),
    30 => array(
        'index' => array('内容审核' => 'action=moderate'),
        'text' => array(0 => '内容审核'),
    ),
    31 => array(
        'index' => array('词语过滤' => 'action=misc&operation=censor'),
        'text' => array(0 => '词语过滤'),
    ),
    32 => array(
        'index' => array('用户举报' => 'action=report'),
        'text' => array(0 => '用户举报'),
    ),
    33 => array(
        'index' => array('标签管理' => 'action=tag'),
        'text' => array(0 => '标签管理'),
    ),
    34 => array(
        'index' => array('淘帖管理' => 'action=collection'),
        'text' => array(0 => '淘帖管理'),
    ),
    35 => array('index' => array('' => 'action='), 'text' => array(0 => null)),
    36 => array(
        'index' => array('论坛主题管理' => 'action=threads'),
        'text' => array(0 => '论坛主题管理'),
    ),
    37 => array(
        'index' => array('论坛批量删帖' => 'action=prune'),
        'text' => array(0 => '论坛批量删帖'),
    ),
    38 => array(
        'index' => array('论坛附件管理' => 'action=attach'),
        'text' => array(0 => '论坛附件管理'),
    ),
    39 => array('index' => array('' => 'action='), 'text' => array(0 => null)),
    40 => array('index' => array('' => 'action='), 'text' => array(0 => null)),
    41 => array(
        'index' => array('群组主题管理' => 'action=threads&operation=group'),
        'text' => array(0 => '群组主题管理'),
    ),
    42 => array(
        'index' => array('群组批量删帖' => 'action=prune&operation=group'),
        'text' => array(0 => '群组批量删帖'),
    ),
    43 => array(
        'index' => array('群组附件管理' => 'action=attach&operation=group'),
        'text' => array(0 => '群组附件管理'),
    ),
    44 => array('index' => array('' => 'action='), 'text' => array(0 => null)),
    45 => array('index' => array('' => 'action='), 'text' => array(0 => null)),
    46 => array(
        'index' => array('主题回收站' => 'action=recyclebin'),
        'text' => array(0 => '主题回收站'),
    ),
    47 => array(
        'index' => array('回帖回收站' => 'action=recyclebinpost'),
        'text' => array(0 => '回帖回收站'),
    ),
    48 => array(
        'index' => array(
        ...
        'text' => array(0 => '版块/群组置顶'),
    ),
    49 => array(
        'index' => array('帖子点评管理' => 'action=postcomment'),
        'text' => array(0 => '帖子点评管理'),
    ),
    50 => array('index' => array('' => 'action='), 'text' => array(0 => null)),
    51 => array('index' => array('' => 'action='), 'text' => array(0 => null)),
    52 => array(
        'index' => array('记录管理' => 'action=doing'),
        'text' => array(0 => '记录管理'),
    ),
    53 => array(
        'index' => array('日志管理' => 'action=blog'),
        'text' => array(0 => '日志管理'),
    ),
    54 => array(
        'index' => array('日志回收站' => 'action=blogrecyclebin'),
        'text' => array(0 => '日志回收站'),
    ),
    55 => array(
        'index' => array('动态管理' => 'action=feed'),
        'text' => array(0 => '动态管理'),
    ),
    56 => array(
        'index' => array('相册管理' => 'action=album'),
        'text' => array(0 => '相册管理'),
    ),
    57 => array(
        'index' => array('图片管理' => 'action=pic'),
        'text' => array(0 => '图片管理'),
    ),
    58 => array(
        'index' => array('评论/留言管理' => 'action=comment'),
        'text' => array(0 => '评论/留言管理'),
    ),
    59 => array(
        'index' => array('分享管理' => 'action=share'),
        'text' => array(0 => '分享管理'),
    ),
    60 => array('index' => array('' => 'action='), 'text' => array(0 => null)),
    61 => array(
        'index' => array('用户管理' => 'action=members&operation=search'),
        'text' => array(0 => '用户管理'),
    ),
    62 => array(
        'index' => array('添加用户' => 'action=members&operation=add'),
        'text' => array(0 => '添加用户'),
    ),
    63 => array(
        'index' => array('用户栏目' => 'action=members&operation=profile'),
        'text' => array(0 => '用户栏目'),
    ),
    64 => array(
        'index' => array('资料统计' => 'action=members&operation=stat'),
        'text' => array(0 => '资料统计'),
    ),
    65 => array(
        'index' => array('发送通知' => 'action=members&operation=newsletter'),
        'text' => array(0 => '发送通知'),
    ),
    66 => array(
        'index' => array(
    ...
    67 => array(
        'index' => array('用户标签' => 'action=usertag'),
        'text' => array(0 => '用户标签'),
    ),
    68 => array(
        'index' => array('禁止用户' => 'action=members&operation=ban'),
        'text' => array(0 => '禁止用户'),
    ),
    69 => array(
        'index' => array('禁止 IP' => 'action=members&operation=ipban'),
        'text' => array(0 => '禁止 IP'),
    ),
    70 => array(
        'index' => array('积分奖惩' => 'action=members&operation=reward'),
        'text' => array(0 => '积分奖惩'),
    ),
    71 => array(
        'index' => array('审核用户' => 'action=moderate&operation=members'),
        'text' => array(0 => '审核用户'),
    ),
    72 => array(
        'index' => array('管理组' => 'action=admingroup'),
        'text' => array(0 => '管理组'),
    ),
    73 => array(
        'index' => array('用户组' => 'action=usergroups'),
        'text' => array(0 => '用户组'),
    ),
    74 => array(
        'index' => array('推荐关注' => 'action=specialuser&operation=follow'),
        'text' => array(0 => '推荐关注'),
    ),
    75 => array(
        'index' => array(
    ...
    76 => array(
        'index' => array('' => 'action=verify&operation=verify'),
        'text' => array(0 => null),
    ),
    77 => array(
        'index' => array('认证设置' => 'action=verify'),
        'text' => array(0 => '认证设置'),
    ),
    78 => array(
        'index' => array('频道栏目' => 'action=portalcategory'),
        'text' => array(0 => '频道栏目'),
    ),
    79 => array(
        'index' => array('文章管理' => 'action=article'),
        'text' => array(0 => '文章管理'),
    ),
    80 => array(
        'index' => array('专题管理' => 'action=topic'),
        'text' => array(0 => '专题管理'),
    ),
    81 => array(
        'index' => array('HTML管理' => 'action=makehtml'),
        'text' => array(0 => 'HTML管理'),
    ),
    82 => array(
        'index' => array('页面管理' => 'action=diytemplate'),
        'text' => array(0 => '页面管理'),
    ),
    83 => array(
        'index' => array('模块管理' => 'action=block'),
        'text' => array(0 => '模块管理'),
    ),
    84 => array(
        'index' => array('模块模板' => 'action=blockstyle'),
        'text' => array(0 => '模块模板'),
    ),
    85 => array(
        'index' => array('第三方模块' => 'action=blockxml'),
        'text' => array(0 => '第三方模块'),
    ),
    86 => array(
        'index' => array('权限列表' => 'action=portalpermission'),
        'text' => array(0 => '权限列表'),
    ),
    87 => array(
        'index' => array('日志分类' => 'action=blogcategory'),
        'text' => array(0 => '日志分类'),
    ),
    88 => array(
        'index' => array('相册分类' => 'action=albumcategory'),
        'text' => array(0 => '相册分类'),
    ),
    89 => array(
        'index' => array('版块管理' => 'action=forums'),
        'text' => array(0 => '版块管理'),
    ),
    90 => array(
        'index' => array('版块合并' => 'action=forums&operation=merge'),
        'text' => array(0 => '版块合并'),
    ),
    91 => array(
        'index' => array('分类信息' => 'action=threadtypes'),
        'text' => array(0 => '分类信息'),
    ),
    92 => array(
        'index' => array('首页四格' => 'action=grid'),
        'text' => array(0 => '首页四格'),
    ),
    93 => array(
        'index' => array('群组设置' => 'action=group&operation=setting'),
        'text' => array(0 => '群组设置'),
    ),
    94 => array(
        'index' => array('群组分类' => 'action=group&operation=type'),
        'text' => array(0 => '群组分类'),
    ),
    95 => array(
        'index' => array('群组管理' => 'action=group&operation=manage'),
        'text' => array(0 => '群组管理'),
    ),
    96 => array(
        'index' => array('群主权限' => 'action=group&operation=userperm'),
        'text' => array(0 => '群主权限'),
    ),
    97 => array(
        'index' => array('群组等级' => 'action=group&operation=level'),
        'text' => array(0 => '群组等级'),
    ),
    98 => array(
        'index' => array('审核群组' => 'action=group&operation=mod'),
        'text' => array(0 => '审核群组'),
    ),
    99 => array(
        'index' => array('基本设置' => 'action=setting&operation=sec'),
        'text' => array(0 => '基本设置'),
    ),
    100 => array(
        'index' => array('验证设置' => 'action=setting&operation=seccheck'),
        'text' => array(0 => '验证设置'),
    ),
    101 => array(
        'index' => array('安全大师' => 'action=optimizer&operation=security'),
        'text' => array(0 => '安全大师'),
    ),
    102 => array(
        'index' => array('帐号保镖' => 'action=setting&operation=accountguard'),
        'text' => array(0 => '帐号保镖'),
    ),
    103 => array(
        'index' => array('站点公告' => 'action=announce'),
        'text' => array(0 => '站点公告'),
    ),
    104 => array(
        'index' => array('站点广告' => 'action=adv'),
        'text' => array(0 => '站点广告'),
    ),
    105 => array(
        'index' => array('站点任务' => 'action=tasks'),
        'text' => array(0 => '站点任务'),
    ),
    106 => array(
        'index' => array('道具中心' => 'action=magics'),
        'text' => array(0 => '道具中心'),
    ),
    107 => array(
        'index' => array('勋章中心' => 'action=medals'),
        'text' => array(0 => '勋章中心'),
    ),
    108 => array(
        'index' => array('站点帮助' => 'action=faq'),
        'text' => array(0 => '站点帮助'),
    ),
    109 => array(
        'index' => array('电子商务' => 'action=setting&operation=ec'),
        'text' => array(0 => '电子商务'),
    ),
    110 => array(
        'index' => array('友情链接' => 'action=misc&operation=link'),
        'text' => array(0 => '友情链接'),
    ),
    111 => array(
        'index' => array('站长推荐' => 'action=misc&operation=focus'),
        'text' => array(0 => '站长推荐'),
    ),
    112 => array(
        'index' => array('关联链接' => 'action=misc&operation=relatedlink'),
        'text' => array(0 => '关联链接'),
    ),
    113 => array(
        'index' => array('充值卡密' => 'action=card'),
        'text' => array(0 => '充值卡密'),
    ),
    114 => array(
        'index' => array('应用中心' => 'action=cloudaddons'),
        'text' => array(0 => '应用中心'),
    ),
    115 => array(
        'index' => array('插件' => 'action=plugins'),
        'text' => array(0 => '插件'),
    ),
    116 => array('index' => array('' => 'action='), 'text' => array(0 => null)),
    117 => array(
        'index' => array('' => 'action=plugins&operation=config&do=1'),
        'text' => array(0 => null),
    ),
    118 => array('index' => array('' => 'action='), 'text' => array(0 => null)),
    119 => array(
        'index' => array('更新缓存' => 'action=tools&operation=updatecache'),
        'text' => array(0 => '更新缓存'),
    ),
    120 => array(
        'index' => array('更新统计' => 'action=counter'),
        'text' => array(0 => '更新统计'),
    ),
    121 => array(
        'index' => array('运行记录' => 'action=logs'),
        'text' => array(0 => '运行记录'),
    ),
    122 => array(
        'index' => array('计划任务' => 'action=misc&operation=cron'),
        'text' => array(0 => '计划任务'),
    ),
    123 => array(
        'index' => array('文件权限检查' => 'action=tools&operation=fileperms'),
        'text' => array(0 => '文件权限检查'),
    ),
    124 => array(
        'index' => array('文件校验' => 'action=checktools&operation=filecheck'),
        'text' => array(0 => '文件校验'),
    ),
    125 => array(
        'index' => array(
    ...
    126 => array(
        'index' => array('后台管理团队' => 'action=founder&operation=perm'),
        'text' => array(0 => '后台管理团队'),
    ),
    127 => array(
        'index' => array('邮件设置' => 'action=setting&operation=mail'),
        'text' => array(0 => '邮件设置'),
    ),
    128 => array(
        'index' => array('UCenter 设置' => 'action=setting&operation=uc'),
        'text' => array(0 => 'UCenter 设置'),
    ),
    129 => array(
        'index' => array('数据库' => 'action=db&operation=export'),
        'text' => array(0 => '数据库'),
    ),
    130 => array(
        'index' => array('用户表优化' => 'action=membersplit&operation=check'),
        'text' => array(0 => '用户表优化'),
    ),
    131 => array(
        'index' => array('帖子分表' => 'action=postsplit&operation=manage'),
        'text' => array(0 => '帖子分表'),
    ),
    132 => array(
        'index' => array('主题分表' => 'action=threadsplit&operation=manage'),
        'text' => array(0 => '主题分表'),
    ),
    133 => array(
        'index' => array(
    ...
    134 => array(
        'index' => array(
            ...
            '主题管理权限' =>
                'action=admingroup&operation=edit&anchor=threadperm',
        ),
        'text' => array(
            0 => '管理组 &raquo; 主题管理权限',
    ...
    135 => array(
        'index' => array(
            '管理组' => 'action=admingroup',
            '帖子管理权限' =>
                'action=admingroup&operation=edit&anchor=postperm',
        ),
        'text' => array(
            0 => '管理组 &raquo; 帖子管理权限',
    ...
    136 => array(
        'index' => array(
            '管理组' => 'action=admingroup',
            '管理面板权限' =>
                'action=admingroup&operation=edit&anchor=modcpperm',
        ),
        'text' => array(
            0 => '管理组 &raquo; 管理面板权限',
    ...
    137 => array(
        'index' => array(
            '管理组' => 'action=admingroup',
            '空间管理权限' =>
                'action=admingroup&operation=edit&anchor=spaceperm',
        ),
        'text' => array(
            0 => '管理组 &raquo; 空间管理权限',
    ...
    139 => array(
        'index' => array(
            '管理组' => 'action=admingroup',
            '门户管理权限' =>
                'action=admingroup&operation=edit&anchor=portalperm',
        ),
        'text' => array(
            0 => '管理组 &raquo; 门户管理权限',
    ...
    151 => array(
        'index' => array('允许前台充值' => 'action=card'),
        'text' => array(
            0 => '允许前台充值',
            1 => 'card_config_open',
            2 => '允许前台充值',
    ...
    152 => array(
        'index' => array(
            '导出充值卡密最多支持 10000 条数据，导出的 .xls 文件可用 EXCEL 等工具打开。' =>
                'action=card&operation=manage',
        ),
        'text' => array(
    ...
    154 => array(
        'index' => array(
            '生成卡密时，简单的规则或较小的生成张数可能导致实际生成张数小于预设生成张数。' =>
                'admin.php?action=card&operation=make',
        ),
        'text' => array(
...
由于涉及现金交易，为避免因操作不当而造成的资金损失，请在开始使用财付通积分交易功能(不包含财付通按钮功能)前，务必仔细阅读《用户使用说明书》中有关电子商务的部分，当确认完全理解和接受相关流程及使用方法后再进行相关设置。您可以设置允许用户通过现金在线支付的方式，为其交易积分账户充值，用于购买帖子内容、购买用户组权限、积分转账或用户组升级等功能。财付通积分交易功能，需在“积分设置”中启用交易积分，并同时设置相应的积分策略以满足不同场合的需要。请务必正确设置您的收款财付通账号，否则将造成用户付款后积分无法实时到账，造成大量需要人工处理的订单信息。除 Discuz! 官方网站或官方论坛另行通知以外，Discuz! 提供的财付通支付服务每笔交易收取 1% 的手续费。请及时关注相关业务的最新通知，各项政策或流程的变更、调整，以 Discuz! 官方网站或官方论坛提供的信息为准。您使用财付通服务是建立在完全自愿的基础上，除 Discuz! 因主观恶意的因素造成的资金损失以外，北京康盛新创科技有限责任公司不对因使用此功能造成的任何损失承担责任。财付通服务热线：0755-83762288-2(全天24小时服务热线)',
    ...
    182 => array(
        ...
        'text' => array(
            ...
            19 => '权限表达式设置',
            20 => '当您设定了权限表达式后，只有符合此表达式的会员才可以浏览本版块。如 "posts > 100 and extcredits1 > 10" 表示 "发帖数 > 100 并且 威望 > 10"日期格式 "{d-m-Y}"，如 "{2009-10-1}"。IP 格式 "{x.x.x.x}"，既可输入完整地址，也可只输入 IP 开头，如 "{10.0.0.1}"、"{192.168.0}"',
    ...
    183 => array(
        'index' => array('后台管理团队' => 'action=founder'),
        'text' => array(
            0 => '后台管理团队',
    ...
    193 => array(
        'index' => array('马甲' => 'action=members&operation=repeat'),
        'text' => array(
            0 => '马甲',
    ...
    195 => array(
        'index' => array('编辑会员用户组' => 'action=members&operation=group'),
        'text' => array(
            0 => '编辑会员用户组',
            1 => 'usergroup',
            2 => '用户组',
    ...
    196 => array(
        'index' => array('编辑用户积分' => 'action=members&operation=credit'),
        'text' => array(
            0 => '编辑用户积分',
    ...
    197 => array(
        'index' => array('编辑用户权限' => 'action=members&operation=access'),
        'text' => array(
            0 => '编辑用户权限',
    ...
    198 => array(
        'index' => array('编辑用户' => 'action=members&operation=edit'),
        'text' => array(
            0 => '编辑用户',
    ...
    200 => array(
        'index' => array('用户分表' => 'action=membersplit&operation=check'),
        'text' => array(
            0 => '用户分表',
...
',
    ...
    233 => array(
        ...
        'text' => array(
            ...
            43 => '关闭顶部导航固定',
            44 => 'Cố định top navigation khi cuộn trang',
        ),
    ),
    234 => array(
        'index' => array(
            '界面设置' => 'action=setting&operation=styles',
            '主题列表页' =>
                'action=setting&operation=styles&anchor=forumdisplay',
        ),
        'text' => array(
            0 => '界面设置 &raquo; 主题列表页',
            1 => 'setting_tips',
    ...
    235 => array(
        ...
        'text' => array(
            ...
            72 => '关闭顶部导航固定',
            73 => 'Cố định top navigation khi cuộn trang',
            74 => 'setting_styles_forumdisplay_threadguestlite',
            75 => '游客阅读简化模式',
            76 => 'Ở chế độ đọc, thông tin người dùng sẽ không hiện',
            77 => 'setting_styles_viewthread_close_leftinfo',
            78 => '关闭左侧信息栏',
            79 => 'Đóng thanh thông tin người dùng ở bên trái',
            80 => 'setting_styles_viewthread_close_leftinfo_userctrl',
            81 => '左侧信息栏允许用户控制',
            82 => 'Khi đọc bài, người dùng có thể tuỳ chỉnh hiện/tắt thanh thông tin bên trái',
            83 => 'setting_styles_viewthread_guestviewthumb',
            84 => '游客看小图',
            85 => 'Khi khách xem bài viết, hình ảnh sẽ hiển thị dạng nhỏ, có thể hiện to lên khi khách đăng nhập',
            ...
            93 => '帖内游客登录提示',
            94 => 'Khi khách xem bài, 1 dòng chữ sẽ hiện lên trên đầu bài viết nhắc đăng nhập',
    ...
    236 => array(
        'index' => array(
            '界面设置' => 'action=setting&operation=styles',
            '帖内用户信息' =>
                'action=setting&operation=styles&anchor=threadprofile',
        ),
        'text' => array(
            0 => '界面设置 &raquo; 帖内用户信息',
    ...
    246 => array(
        'index' => array(
            '站点功能' => 'action=setting&operation=functions',
            '主题热度' =>
                'action=setting&operation=functions&anchor=heatthread',
        ),
        'text' => array(
            0 => '站点功能 &raquo; 主题热度',
    ...
    254 => array(
        ...
        'text' => array(
            ...
            40 => 'Tạo nhóm để dùng điểm',
            41 => 'Points to be consumed when creating a group',
    ...
    257 => array(
        'index' => array(
            ...
            '注册表单名称设置' =>
                'action=setting&operation=sec&anchor=accountguard',
        ),
        'text' => array(
    ...
    261 => array(
        'index' => array(
            '基本设置' => 'action=setting&operation=sec',
            '注册表单名称设置' =>
                'action=setting&operation=sec&anchor=reginput',
        ),
        'text' => array(
    ...
    262 => array(
        'index' => array(
            '基本设置' => 'action=setting&operation=sec',
            '注册表单名称设置' =>
                'action=setting&operation=sec&anchor=postperiodtime',
        ),
        'text' => array(
            0 => '基本设置 &raquo; 注册表单名称设置',
    ...
    267 => array(
        'index' => array(
            '上传设置' => 'action=setting&operation=attach',
            '门户附件' =>
                'action=setting&operation=attach&anchor=portalarticle',
        ),
        'text' => array(
            0 => '上传设置 &raquo; 门户附件',
