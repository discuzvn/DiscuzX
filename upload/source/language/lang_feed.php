...
$lang = array(
    ...
    'feed_comment_event' =>
        '{actor} đã nhận xét {touser} hoạt động nhóm {event} ',
    'feed_comment_share' => '{actor} đã bình luận {touser} chia sẻ {share}',
    'feed_showcredit' =>
        '{actor} đã tặng cho {fusername} điểm {credit} , giúp họ lên hạng ở <a href="home.php?mod=space&do=top" target="_blank">bảng xếp hạng</a>',
    'feed_showcredit_self' =>
        '{actor} đã trả {credit} điểm, để nâng thứ hạng của mình trên <a href="home.php?mod=space&do=top" target="_blank">bảng xếp hạng</a>',
    'feed_doing_title' => '{actor}：{message}',
    'feed_friend_title' => '{actor} và {touser} đã trở thành bạn bè',
    'feed_click_blog' =>
        '{actor} đã tặng 1 "{click}" cho bài viết {subject} của {touser}',
    'feed_click_thread' =>
        '{actor} đã tặng 1 "{click}" cho  bài viết {subject} của {touser}',
    'feed_click_pic' =>
        '{actor} đã tặng 1 "{click}" cho hình ảnh của {touser} ',
    'feed_click_article' =>
        '{actor} đã tặng 1 "{click}" cho tác phẩm {subject} của {touser}',
    'feed_task' => '{actor} đã hoàn thành nhiệm vụ {task}',
    'feed_task_credit' =>
        '{actor} hoàn thành nhiệm vụ {task},  nhận được {credit} điểm thưởng',
    ...
    'feed_add_attachsize' =>
        '{actor} dùng {credit} điểm để đổi {size} dung lượng file đính kèm, có thể upload nhiều hình ảnh hơn.(<a href="home.php?mod=spacecp&ac=credit&op=addsize"> click vào đây để đổi</a>)',
    'feed_invite' => '{actor} đã gửi lời mời, và đã kết bạn với {username}',
    'magicuse_thunder_announce_title' =>
        '<strong>{username} gửi "tán thành"</strong>',
    'magicuse_thunder_announce_body' =>
        'Chào cả nhà, tôi đang online nè !<br /><a href="home.php?mod=space&uid={uid}" target="_blank"> Rất vui khi bạn ghé thăm blog của tôi</a>',
    ...
    'feed_thread_goods_message_1' =>
        '<b>{itemname}</b><br />Price {itemprice} USD and {itemcredit}{creditunit}',
    'feed_thread_goods_message_2' =>
        '<b>{itemname}</b><br />Price {itemprice} USD',
    'feed_thread_goods_message_3' =>
        '<b>{itemname}</b><br />Price {itemcredit}{creditunit}',
    'feed_thread_reward_title' => '{actor} tung ra một phần thưởng mới',
    'feed_thread_reward_message' =>
        '<b>{subject}</b><br />Phần thưởng {rewardprice}{extcredits}',
    ...
    'feed_thread_activity_message' =>
        '<b>{subject}</b><br />Thời gian bắt đầu： {starttimefrom}<br /> Địa điểm {activityplace}<br />{message}',
    ...
    'feed_thread_debate_message' =>
        '<b>{subject}</b><br />Đồng tình: {affirmpoint}<br />Đối lập: {negapoint}<br />{message}',
    'feed_thread_debatevote_title_1' =>
        '{actor} đã đồng tình với biện luận của {subject}',
    'feed_thread_debatevote_title_2' =>
        '{actor} đã phản đối với biện luận của {subject}',
    'feed_thread_debatevote_title_3' =>
        '{actor} đã trung lập với biện luận của {subject}',
